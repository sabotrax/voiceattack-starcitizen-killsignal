...
- anhalten; Halt Halt; Schub 0; Stopp Stopp; Vollbremsung - reduziert den Schub auf Null.
...
- Auf geht's; Auf jeden [Fall;]; Bestätige; Ja [bitte; ist es; klar; Mama; schon; sicher; sind wir]; Ja wohl; jawoll; [Klar; Sicher] [doch;]; Mach schon; Natürlich; Sicherlich - dient zur Bestätigung von Nachfragen bei z.B. "abheben" oder "landen".
...
- Freund minus; Vorheriger Freund - wechselt zum vorherigen freundlich gesinnten Ziel.
- Freund plus; Nächster Freund - wechselt zum nächten freundlich gesinnten Ziel.
...
- los los; Schub 100; volle Kraft [voraus;]; voller Schub; Vollgas - gibt maximalen SCM-Schub.
...
- spring; springe; springen; Sprung - aktiviert den Quantum-Antrieb.
